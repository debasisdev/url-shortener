...
public class UrlService implements IService<Url> {
	...
	/**
	 * Generates a short hash from database id.
	 * 
	 * @param databaseId
	 *            id of URL
	 * @return auto-generated base62 hash
	 */
	...
	/**
	 * Generates an long number from a given base62 hash.
	 * 
	 * @param shortUrl
	 *            hash
	 * @return datbase id
	...
	/**
	 * Checks a URL is valid or not.
	 * 
	 * @param url
	 *            URL enitiy
	 * @return whether url or not
	 */
	...
	/**
	 * Extracts the hash part from the short URL.
	 * 
	 * @param shortUrl
	 *            short URL
